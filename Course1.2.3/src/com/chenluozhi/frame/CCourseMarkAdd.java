...
public class CCourseMarkAdd extends JDialog {
	...
	private void initialize() {
		...
		this.setSize(510, 178);
		this.setModal(true);
		this.setLocationRelativeTo(null);
		this.setTitle("已选课程成绩录入");
		jLabel3 = new JLabel();
		jLabel3.setBounds(new Rectangle(19, 106, 314, 26));
		jLabel3.setText("注：“开启过滤”只显示学生成绩还没被录入的课程。");

		jLabel5 = new JLabel();
		jLabel5.setBounds(new Rectangle(202, 73, 65, 18));
		...
		jCheckBox_stu_filter.setBounds(new Rectangle(420, 72, 86, 23));
