...
public class CCourseMarkStatistic extends JDialog {
	...
	private void initialize() {
		...
		jLabel11 = new JLabel();
		jLabel11.setText("女生：");
		jLabel11.setBounds(new Rectangle(191, 60, 45, 25));
		jLabel10 = new JLabel();
		jLabel10.setText("男生：");
		jLabel10.setBounds(new Rectangle(192, 89, 45, 25));
		...
		jPanel.setBorder(BorderFactory.createTitledBorder("课程数据分析"));
	...
	public void flashData(){
		...
		// 数据清空
		jLabel_course_good.setText(null);
		jLabel_course_ok.setText(null);
		jLabel_course_boy.setText(null);
		jLabel_course_girl.setText(null);
		...
		jLabel_course_good.setText(decimalFormat.format(((double) Integer.parseInt(course_goodRadio.get(1)) / totalCounts) * 100) + "%");
		jLabel_course_ok.setText(decimalFormat.format(((double) Integer.parseInt(course_goodRadio.get(2)) / totalCounts) * 100) + "%");
	...
	public static void main(String[] args) {
		CCourseMarkStatistic cc = new CCourseMarkStatistic();
		cc.setVisible(true);
	}
}
