...
public class ClassDao {
	 ...
	 * @return 多行数据
	 */
	public List<ClassModel> getLists()//从c_class表中获取所有班级记录，并将它们转换为ClassModel对象列表。
	 {
	...
	public List<ClassModel> getListsByGradeId(int grade_id)//根据年级ID查询并返回一个包含对应年级所有班级信息的ClassModel对象列表。
	 {
	...
	public boolean addClass(String class_name,Integer grade_id,Integer max_num)//插入一个新的班级记录
	 {
